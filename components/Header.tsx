                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white/10 backdrop-blur-xl rounded-lg border border-white/20 shadow-lg">
                    <div className="py-2">
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-2 text-gray-200 hover:bg-white/10 hover:text-red-400 transition-colors flex items-center space-x-2 cursor-pointer"
                      >
                        <LogOut size={16} />
                        <span>로그아웃</span>
                      </button>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              {!user ? (
                ...
                <div className="border-t border-white/10 pt-2 mt-2">
                  ...
                  <button
                    onClick={handleSignOut}
                    className="w-full text-left py-2 px-2 text-gray-200 hover:text-red-400 transition-colors flex items-center space-x-2 hover:bg-white/10 pointer cursor-pointer"
                  >
                    <LogOut size={16} />
                    <span>로그아웃</span>
                  </button>
